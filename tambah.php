<html>
<head>
 <title>Aplikasi CRUD Sederhana | nalnalfeel</title>
</head>
<body style="font-family:arial">
 <center><h2>Aplikasi CRUD Sederhana <br /> nalnalfeel</h2></center>
 <hr />
 <b>Tambah Data Baru</b>
    ...
    <form action="tambah.php" method="post" name="form1">
        <table width="100%" border="0">
            <tr> 
                <td>Kode Barang</td>
                <td><input type="text" name="Kode_barang" size="50" required></td>
            </tr>
            <tr> 
                <td>Nama Barang</td>
